package com.meonghae.s3fileservice.core.config;
...
public class Swagger2Config {
    ...
    @Bean(name = "s3_file_api")
    public Docket s3FileServiceApi() {
        Predicate<String> path = PathSelectors.ant("/s3-file-service/**");

        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("File Service API")
                .select()
                .paths(path)
                .build()
                .apiInfo(commnuityApiInfo());
